	  ...
	  <table border="0" cellspacing="0" cellpadding="5">
	    ...
	    <tbody>
	        ...
	        <td align="left" valign="top">
			  ...
			  <option value="">โปรดเลือกยศ</option>
				  ...
				  while($rsRank = $rnk->fetch()){
					  ?>
				  <option value="<?php echo($rsRank['rid']);?>" <?php if($rank==$rsRank['rid']){ echo "selected"; } ?>>
              ...
              <select name="pid" id="pid">
                <option value="null">โปรดเลือกตำแหน่งของท่าน</option>
				  ...
				  while($rsPst = $pst->fetch()){
					  ?>
				  <option value="<?php echo($rsPst['pid']);?>" <?php if($pid==$rsPst['pid']){ echo "selected"; } ?>>
              ...
              <select name="salary" id="salary">
                <option value="null">โปรดเลือกเงินเดือนของท่าน</option>
				  ...
				  while($rsSal = $sal->fetch()){
					  ?>
				  <option value="<?php echo($rsSal['s_name']);?>" <?php if($salary==$rsSal['s_name']){ echo "selected"; } ?>>
	      ...
	      <tr>
			...
			&nbsp;
			<input type="button" name="Reset" id="Reset" value="Reset"></td>
          </tr>
	      <tr>
